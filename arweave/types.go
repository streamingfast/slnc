...
type Transaction struct {
	...
	owner     *big.Int // The modulus of the RSA Wallet pair corresponding to the wallet making the transaction
...
type transactionJSON struct {
	...
	//Owner is the modulus of the RSA Wallet pair corresponding to the wallet making the transaction, base64url encoded.
